...
@WebServlet("/GetFlightsFinal")
public class GetFlightsFinal extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    
    public GetFlightsFinal() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Flight> flightList=flightDao2.showFlightDestination(f);//the final list to be sent to dikshtra's
